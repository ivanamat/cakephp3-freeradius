...
<main class="groups add large-10 medium-9 columns content">
    <?php echo $this->Form->create('Group'); ?>
        <section>
            <h2 class='left'><?php echo __('New group'); ?></h2>
            <div class="right">
                ...
                <div class="panel">
                    <div class="panel-body">
                        <table class="vertical-table transparent inverted">
                            <tbody>
                                <tr>
                                    <th class="w25"><div class="input text required"><label for="groupname"><?php echo __('Group Name'); ?></label></div></th>
                                    <td><?php echo $this->Form->input('groupname', ['label' => false,'required' => true]); ?></td>
                                </tr>
                                <tr>
                                    <th class="w25"><label for="wispr-location-id"><?php echo __('Location ID'); ?></label></th>
                                    <td><?php echo $this->Form->input('WISPr-Location-ID', ['label' => false]); ?></td>
                                </tr>
                                <tr>
                                    <th class="w25"><label for="wispr-location-name"><?php echo __('Location Name'); ?></label></th>
